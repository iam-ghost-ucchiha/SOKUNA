...
setTimeout(() => {a({body: "জান তুমি জুবায়ের বসের কাছে চলে জাও" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "তুমি এতো hot এক দম জুবায়ের এর মনের মতো🙈💋" + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: "জান তুমি এতো sexy কেন জুবায়ের তো পাগল হইয়া গেছে 😍.." + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a("Collected From 𝐌𝐎𝐇𝐀𝐌𝐌𝐀𝐃 𝐉𝐔𝐁𝐀𝐘𝐄𝐑–🤍💚🥀࿐")} , 20000);
